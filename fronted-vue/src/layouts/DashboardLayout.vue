<template>
  <div class="dashboard-layout">
    <a
      ...
      :style="skipLinkFocused ? 'position: absolute; top: 1rem; left: 1rem; z-index: 9999;' : 'position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; border-width: 0;'"
