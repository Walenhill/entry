        ...
        <div class="form-group mb-4">
          ...
          <div class="password-input-wrapper">
            <input
              ...
              :disabled="isLoading"
              :aria-invalid="!!error"
              :aria-describedby="[error ? 'login-error' : '', isCapslockOn ? 'capslock-warning' : ''].filter(Boolean).join(' ') || null"
              @keyup="checkCapslock"
          ...
          <div v-if="isCapslockOn" id="capslock-warning" class="mt-2 text-warning" role="alert" aria-live="polite" style="font-size: 0.875rem; display: flex; align-items: center; gap: 0.25rem;">
            <span aria-hidden="true">⚠️</span> Включен Caps Lock
          </div>
        </div>
