...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        try {
            // Performance optimization: Using 'p:' prefix simulates connection pooling
            // by creating persistent connections, reducing TCP handshake and authentication latency.
