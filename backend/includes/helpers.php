...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        try {
            // Performance optimization: Prefixing host with 'p:' enables persistent connections,
            // which reduces TCP handshake and authentication latency for subsequent API requests.
