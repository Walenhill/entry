...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        try {
            // Performance optimization: Prefixing the host with 'p:' enables persistent database connections in PHP mysqli.
            // This acts as connection pooling, reducing the overhead of TCP handshakes and MySQL authentication on every request.
