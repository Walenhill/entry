...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        // Performance optimization: Prefix host with 'p:' to enable persistent connections (connection pooling)
        // This avoids TCP handshake and authentication latency on every request
        if (strpos($host, 'p:') !== 0) {
            $host = 'p:' . $host;
        }
