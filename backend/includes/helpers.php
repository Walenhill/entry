...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        try {
            ...
            // Prepending "p:" to the host enables persistent database connections in mysqli.
            // This acts as connection pooling, reducing latency by avoiding the TCP handshake
            // and authentication overhead for every single API request.
