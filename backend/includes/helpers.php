...
function getDbConnection() {
    ...
    if ($conn === null) {
        ...
        try {
            // Performance optimization: Prefix host with 'p:' to enable persistent connections in mysqli.
            // This acts as a simple connection pool, reducing TCP handshake and authentication overhead
