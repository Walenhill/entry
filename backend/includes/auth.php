...
function loginAdmin($password) {
    ...
    if (filter_var($ipAddress, FILTER_VALIDATE_IP, FILTER_FLAG_NO_PRIV_RANGE | FILTER_FLAG_NO_RES_RANGE) === false && getenv('TRUST_X_FORWARDED_FOR') === 'true') {
    ...
    if (!$storedHash) {
        ...
        if ($defaultPassword === 'admin123' || $defaultPassword === 'change_this_master_password') {
