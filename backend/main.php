...
// Performance optimization: Cache CORS OPTIONS preflight response in the browser for 24 hours
// Impact: Halves the network roundtrips for subsequent cross-origin API calls with credentials
