...
-- Performance optimization: Covering index for top clients query in getStatistics()
CREATE INDEX IF NOT EXISTS idx_booked_clients ON slots(status, client_phone, client_name);
