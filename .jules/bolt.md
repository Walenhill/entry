...
## 2024-06-27 - Persistent MySQLi Connections
**Learning:** Establishing a new database connection for every API request incurs significant TCP handshake and authentication latency overhead.
**Action:** Use persistent connections in MySQLi by prefixing the database host with `p:` (e.g., `p:localhost`) to simulate connection pooling and improve response times.
