...
## 2026-09-01 - Focus states for structural buttons
**Learning:** Standalone structural buttons lack clear focus rings by default in this app.
**Action:** Always explicitly define :focus-visible states using outline: none and a themed box-shadow.
