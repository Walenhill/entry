...
## 2026-08-31 - Ensure clear focus rings on structural buttons
**Learning:** Standalone structural buttons like .close-btn lack clear focus rings by default, making keyboard navigation difficult.
**Action:** Always explicitly define :focus-visible states using outline: none and a themed box-shadow for structural buttons.
