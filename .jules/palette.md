...
## 2024-07-30 - Prevent Background Scrolling for Overlays
**Learning:** Found that opening full-screen overlays (like modals or mobile sidebars) allows the page background to continue scrolling, which can be disorienting and disrupt the user's context.
**Action:** Always set document.body.style.overflow = 'hidden' when a full-screen overlay opens, and explicitly restore it to '' when it closes or unmounts.
