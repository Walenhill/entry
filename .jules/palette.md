...
## 2026-05-20 - Ensure focus visibility for interactive structural icons
**Learning:** Icon-only structural buttons like .close-btn, .close-mobile, and .menu-toggle did not have explicit :focus-visible states defined, which created invisible focus issues during keyboard navigation (a11y regression).
**Action:** Always provide explicit :focus-visible states for standalone interactive structural icon buttons, utilizing existing system color variables and standard border radii.
